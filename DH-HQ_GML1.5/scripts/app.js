...
function showLegend(){ try{ document.getElementById('legend-section')?.classList.remove('hidden'); }catch(e){} }
    ...
    hideLegend();
        ...
        function renderGameLogs(gameLogs, player, playerRanks) {
            ...
            const rbStatOrder = ['fpts', 'rush_att', 'rush_yd', 'rush_td', 'ypc', 'fum_lost', 'rec_targets', 'rec', 'rec_yd', 'rec_td'];
            const wrTeStatOrder = ['fpts', 'rec_targets', 'rec', 'rec_yd', 'rec_td', 'rush_att', 'rush_yd', 'rush_td', 'ypc', 'fum_lost'];
            ...
            if (player.pos === 'QB') {
                ...
                orderedStatKeys = ['fpts', 'pass_att', 'pass_cmp', 'pass_yd', 'pass_td', 'rush_att', 'rush_yd', 'rush_td', 'ypc', 'rec_targets', 'rec', 'rec_yd', 'rec_td', 'fum_lost'];
            }
