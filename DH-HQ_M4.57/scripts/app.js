    ...
    hideLegend();
        ...
        function renderPlayerComparison(players) {
            ...
            players.forEach(player => {
                ...
                summaryChipsContainer.innerHTML = `
                    <div class="summary-chip">
                        <h4>FPTS <span class="chip-separator">•</span> <span style="color: ${getRankColor(player.overallRank)}">${player.total_pts}</span></h4>
                        <div class="chip-values">
                    ...
                    <div class="summary-chip">
                        <h4>PPG <span class="chip-separator">•</span> <span style="color: ${getRankColor(player.ppgOverallRank)}">${player.ppg}</span></h4>
                        <div class="chip-values">
