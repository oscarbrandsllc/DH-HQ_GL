...
function showLegend(){ try{ document.getElementById('legend-section')?.classList.remove('hidden'); }catch(e){} }
        ...
        let gameLogsModal, modalCloseBtn, modalOverlay, modalPlayerName, modalBody,
            statsKeyModal, statsKeyTrigger, statsKeyCloseBtn, statsKeyOverlay;
        ...
        if (pageType === 'rosters') {
            ...
            statsKeyModal = document.getElementById('stats-key-modal');
            statsKeyTrigger = document.querySelector('.stats-key-trigger');
            statsKeyCloseBtn = statsKeyModal.querySelector('.modal-close-btn');
            statsKeyOverlay = statsKeyModal.querySelector('.modal-overlay');
